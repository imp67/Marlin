...
#define STRING_CONFIG_H_AUTHOR "(IMP, ADPro-BIQU-UART-BLTzmax)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AD-Pro Imp M21xBF UART BLTz+"
...
#define HOTEND_OFFSET_Y { 0.0, 0.000 }  // (mm) relative Y-offset for each nozzle
 ...
 *
 */
#define TEMP_SENSOR_0 1 //**IMP-H2 change from 1
#define TEMP_SENSOR_1 1 //**IMP-H2 change from 1
...
#define TEMP_SENSOR_BED 1 //**IMP-H2 change from 1
...
#define BED_MAXTEMP      120 //**IMP-H2 for ABS
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW  //**IMP
#define X_MAX_ENDSTOP_HIT_STATE LOW  //**IMP
#define Y_MIN_ENDSTOP_HIT_STATE LOW  //**IMP
#define Y_MAX_ENDSTOP_HIT_STATE LOW  //**IMP
#define Z_MIN_ENDSTOP_HIT_STATE LOW  //**IMP
#define Z_MAX_ENDSTOP_HIT_STATE HIGH //**IMP-BLT Z-max
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH //**IMP-BLT Z-max
...
//
#define STARTUP_TUNE { 698, 300, 0, 50, 523, 50, 0, 25, 494, 50, 0, 25, 523, 100, 0, 50, 554, 300, 0, 100, 523, 300 } //**IMP-Try it out!
...
//#define TFT_GENERIC
  ...
  #define TFT_INTERFACE_FSMC //**IMP-Display settings
