...
#define ARTIST_D_PRO_VERSION "Version:Artist-D Pro BiquH2 M211LR Imp v2023.04.25"
/**IMP-Build information *ANZAC Day Release*
AUthor:     Imp67  
...
#define STRING_CONFIG_H_AUTHOR "(IMP, ADPro-BIQU-noUART-noBLT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AD-Pro BiquH2 Imp M212"
 ...
 */
#define PROBE_MANUALLY //**IMP-BLTouch
...
#define PROBING_MARGIN 10 //**IMP-BLTouch OFF
...
//#define DISABLE_INACTIVE_EXTRUDER   // Keep only the active extruder enabled **IMP-Disable for Duplication mode to work v2093
...
//#define DEBUG_LEVELING_FEATURE //**IMP-Debug info
  ...
  #define GRID_MAX_POINTS_X 3 // **IMP-BLTouch 4
